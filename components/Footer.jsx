                ...
                <div className={styles.grid}>
                    <div className={styles.info}>
                        ...
                        <div className={styles.contactItems}>
                            ...
                            <div className={styles.contactItem} style={{ alignItems: "flex-start", flexDirection: "column", gap: "8px", borderRadius: "12px" }}>
                                <div style={{ display: "flex", gap: "10px", alignItems: "flex-start" }}>
                                    <MapPin size={18} style={{ marginTop: "2px", flexShrink: 0, color: "var(--accent-cyan)" }} />
